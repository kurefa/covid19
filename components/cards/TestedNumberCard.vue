...
<i18n>
{
  ...
  "en": {
    ...
    "県内発生（疑い例・接触者調査）": "Emerged in Tokyo (Suspected cases or contactees)",
  ...
  "zh-cn": {
    "検査実施数": "送检件数",
    "県内発生（疑い例・接触者調査）": "佐賀県案例（疑似感染、接触者调查）",
  ...
  "zh-tw": {
    "検査実施数": "送檢件數",
    "県内発生（疑い例・接触者調査）": "佐賀県案例（疑似感染、接觸者調查）",
  ...
  "ko": {
    "検査実施数": "검사실시수",
    "県内発生（疑い例・接触者調査）": "사가 지역사회 발생 경우（의심환자, 접촉자）",
  ...
  "ja-basic": {
    "検査実施数": "けんさした かず",
    "県内発生（疑い例・接触者調査）": "さがけんで びょうき かもしれない ひと",
...
export default {
  ...
  data() {
    ...
    const inspectionsGraph = [
      Data.inspections_summary.data['佐賀県内'],
